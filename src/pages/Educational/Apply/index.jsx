...
class Apply extends Component {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'educationalAndApply/fetchAdvanced',
    });
  }
  ...
  render() {
    ...
    const { educationalAndApply, loading } = this.props;
    const { advancedOperation1, advancedOperation2, advancedOperation3 } = educationalAndApply;
    const contentList = {
      tab1: (
        <Table
          pagination={false}
...
export default connect(({ educationalAndApply, loading }) => ({
  educationalAndApply,
  loading: loading.effects['educationalAndApply/fetchAdvanced'],
}))(Apply);
