...
class CollectivePlan extends Component {
  state = {
    operationKey: 'tab1',
    tabActiveKey: 'detail',
  };
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'rehabilitationAndCollectivePlan/fetchAdvanced',
    });
  }
  ...
  render() {
    ...
    const { rehabilitationAndCollectivePlan, loading } = this.props;
    const {
      advancedOperation1,
      advancedOperation2,
      advancedOperation3,
    } = rehabilitationAndCollectivePlan;
    const contentList = {
      tab1: (
        <Table
          pagination={false}
...
export default connect(({ rehabilitationAndCollectivePlan, loading }) => ({
  rehabilitationAndCollectivePlan,
  loading: loading.effects['rehabilitationAndCollectivePlan/fetchAdvanced'],
}))(CollectivePlan);
