...
class DiagnosisPrescription extends Component {
  state = {
    operationKey: 'tab1',
    tabActiveKey: 'detail',
  };
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'medicalExaminationAndDiagnosisPrescription/fetchAdvanced',
    });
  }
  ...
  render() {
    ...
    const { medicalExaminationAndDiagnosisPrescription, loading } = this.props;
    const {
      advancedOperation1,
      advancedOperation2,
      advancedOperation3,
    } = medicalExaminationAndDiagnosisPrescription;
    const contentList = {
      tab1: (
        <Table
          pagination={false}
...
export default connect(({ medicalExaminationAndDiagnosisPrescription, loading }) => ({
  medicalExaminationAndDiagnosisPrescription,
  loading: loading.effects['medicalExaminationAndDiagnosisPrescription/fetchAdvanced'],
