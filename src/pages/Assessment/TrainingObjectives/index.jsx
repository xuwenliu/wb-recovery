...
const TrainingObjectives = ({ submitting, dispatch }) => {
  ...
  const onFinish = (values) => {
    setError([]);
    dispatch({
      type: 'assessmentAndTrainingObjectives/submitAdvancedForm',
      payload: values,
    });
  };
...
export default connect(({ loading }) => ({
  submitting: loading.effects['assessmentAndTrainingObjectives/submitAdvancedForm'],
}))(TrainingObjectives);
