...
class EvaluationCourses extends Component {
  state = {
    operationKey: 'tab1',
    tabActiveKey: 'detail',
  };
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'assessmentAndEvaluationCourses/fetchAdvanced',
    });
  }
  ...
  render() {
    ...
    const { assessmentAndEvaluationCourses, loading } = this.props;
    const {
      advancedOperation1,
      advancedOperation2,
      advancedOperation3,
    } = assessmentAndEvaluationCourses;
    const contentList = {
      tab1: (
        <Table
          pagination={false}
...
export default connect(({ assessmentAndEvaluationCourses, loading }) => ({
  assessmentAndEvaluationCourses,
  loading: loading.effects['assessmentAndEvaluationCourses/fetchAdvanced'],
}))(EvaluationCourses);
