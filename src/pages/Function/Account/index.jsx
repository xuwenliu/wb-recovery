...
class Account extends Component {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'functionAndAccount/fetchAdvanced',
    });
  }
  ...
  render() {
    ...
    const { functionAndAccount, loading } = this.props;
    const { advancedOperation1, advancedOperation2, advancedOperation3 } = functionAndAccount;
    const contentList = {
      tab1: (
        <Table
          pagination={false}
...
export default connect(({ functionAndAccount, loading }) => ({
  functionAndAccount,
  loading: loading.effects['functionAndAccount/fetchAdvanced'],
}))(Account);
