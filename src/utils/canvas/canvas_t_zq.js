...
var M = function () {
  this.t = function (canvas, data, title, content, fix_score, totall) {
    ...
    var HB = 1050 / arr_count;
    var m = new muban(HB, 80, 100, 100);
    m.box(ctx, arr_count, 4); //画格子
    m.line(ctx, arr_count, 4, arr, fix_score, v_or_h, arr2); //画线
